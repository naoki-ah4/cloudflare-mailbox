        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">連絡先メールアドレス</label>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <Form method="post" className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    id="language"
                    name="language"
                    defaultValue={actionData?.data?.language || settings.language}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <select
                    id="timezone"
                    name="timezone"
                    defaultValue={actionData?.data?.timezone || settings.timezone}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
              ...
              <div className="pt-4 border-t border-gray-200">
                <h3 className="text-base font-medium text-gray-900 mb-3">通知設定</h3>
